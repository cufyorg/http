 ...
 */
public interface EndpointResponse<E extends Endpoint, R extends EndpointRequest<E, Self, R>, Self extends EndpointResponse<E, R, Self>> extends ResponseExtension<Self>, EndpointWrapper<E, Self> {
	/**
