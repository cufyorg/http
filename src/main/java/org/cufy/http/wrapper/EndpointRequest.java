 ...
 */
public interface EndpointRequest<E extends Endpoint, R extends EndpointResponse<E, Self, R>, Self extends EndpointRequest<E, R, Self>> extends RequestExtension<Self>, EndpointWrapper<E, Self> {
	/**
