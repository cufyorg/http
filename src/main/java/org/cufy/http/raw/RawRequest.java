...
public class RawRequest implements Request {
	...
	public RawRequest(@NotNull Request request) {
		...
		this.requestLine = new RawRequestLine(request.getRequestLine());
		this.headers = new RawHeaders(request.getHeaders());
	 ...
	 * @since 0.0.6 ~2021.03.30
	 */
	public RawRequest(@NotNull String value, @NotNull RequestLine requestLine, @NotNull Headers headers, @Nullable Body body) {
		Objects.requireNonNull(value, "value");
		Objects.requireNonNull(requestLine, "requestLine");
		Objects.requireNonNull(headers, "headers");
		this.value = value;
		this.requestLine = new RawRequestLine(requestLine);
