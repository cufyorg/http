...
/**
 * A raw implementation of the interface {@link Host}.
 *
 * @author LSafer
 * @version 0.0.6
 * @since 0.0.6 ~2021.03.30
 */
public class RawHost implements Host {
	 ...
	 * @since 0.0.6 ~2021.03.30
	 */
	public RawHost(@NotNull @NonNls String value) {
