...
public interface Authority extends Cloneable, Serializable {
	 ...
	 */
	static Authority parse(@NotNull @NonNls @Pattern(URIRegExp.AUTHORITY) @Subst("x:y@z:8") String source) {
	...
	@NotNull
	@Contract(value = "_->this", mutates = "this")
	default Authority host(@NotNull @NonNls @Pattern(URIRegExp.HOST) @Subst("example.com") String host) {
	...
	@NotNull
	@Contract(value = "_->this", mutates = "this")
	default Authority port(@NotNull @NonNls @Pattern(URIRegExp.PORT) @Subst("4000") String port) {
	...
	@NotNull
	@Contract(value = "_->this", mutates = "this")
	default Authority userinfo(@NotNull @NonNls @Pattern(URIRegExp.USERINFO) @Subst("admin:admin") String userinfo) {
