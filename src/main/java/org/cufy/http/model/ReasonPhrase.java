...
public interface ReasonPhrase extends Serializable {
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase ACCEPTED = new ReasonPhraseImpl("Accepted");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase ALREADY_REPORTED = new ReasonPhraseImpl("Already Reported");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase BAD_GATEWAY = new ReasonPhraseImpl("Bad Gateway");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase BAD_REQUEST = new ReasonPhraseImpl("Bad Request");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase CONFLICT = new ReasonPhraseImpl("Conflict");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase CONTINUE = new ReasonPhraseImpl("Continue");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase CREATED = new ReasonPhraseImpl("Created");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase EXPECTATION_FAILED = new ReasonPhraseImpl("Expectation Failed");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase FAILED_DEPENDENCY = new ReasonPhraseImpl("Failed Dependency");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase FORBIDDEN = new ReasonPhraseImpl("Forbidden");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase FOUND = new ReasonPhraseImpl("Found");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase GATEWAY_TIMEOUT = new ReasonPhraseImpl("Gateway Timeout");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase GONE = new ReasonPhraseImpl("Gone");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase HTTP_VERSION_NOT_SUPPORTED = new ReasonPhraseImpl("HTTP Version Not Supported");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase IM_USED = new ReasonPhraseImpl("IM Used");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase INSUFFICIENT_STORAGE = new ReasonPhraseImpl("Insufficient Storage");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase INTERNAL_SERVER_ERROR = new ReasonPhraseImpl("Internal Server Error");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase I_AM_A_TEAPOT = new ReasonPhraseImpl("I'm a teapot");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase LENGTH_REQUIRED = new ReasonPhraseImpl("Length Required");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase LOCKED = new ReasonPhraseImpl("Locked");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase LOOP_DETECTED = new ReasonPhraseImpl("Loop Detected");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase METHOD_NOT_ALLOWED = new ReasonPhraseImpl("Method Not Allowed");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase MISDIRECTED_REQUEST = new ReasonPhraseImpl("Misdirected Request");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase MOVED_PERMANENTLY = new ReasonPhraseImpl("Moved Permanently");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase MULTIPLE_CHOICES = new ReasonPhraseImpl("Multiple Choices");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase MULTI_STATUS = new ReasonPhraseImpl("Multi-Status");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase NETWORK_AUTHENTICATION_REQUIRED = new ReasonPhraseImpl("Network Authentication Required");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase NON_AUTHORITATIVE_INFORMATION = new ReasonPhraseImpl("Non-Authoritative Information");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase NOT_ACCEPTABLE = new ReasonPhraseImpl("Not Acceptable");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase NOT_EXTENDED = new ReasonPhraseImpl("Not Extended");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase NOT_FOUND = new ReasonPhraseImpl("Not Found");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase NOT_IMPLEMENTED = new ReasonPhraseImpl("Not Implemented");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase NOT_MODIFIED = new ReasonPhraseImpl("Not Modified");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase NO_CONTENT = new ReasonPhraseImpl("No Content");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase OK = new ReasonPhraseImpl("OK");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase PARTIAL_CONTENT = new ReasonPhraseImpl("Partial Content");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase PAYLOAD_TOO_LARGE = new ReasonPhraseImpl("Payload Too Large");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase PAYMENT_REQUIRED = new ReasonPhraseImpl("Payment Required");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase PERMANENT_REDIRECT = new ReasonPhraseImpl("Permanent Redirect");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase PRECONDITION_FAILED = new ReasonPhraseImpl("Precondition Failed");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase PRECONDITION_REQUIRED = new ReasonPhraseImpl("Precondition Required");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase PROCESSING = new ReasonPhraseImpl("Processing ");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase PROXY_AUTHENTICATION_REQUIRED = new ReasonPhraseImpl("Proxy Authentication Required");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase RANGE_NOT_SATISFIABLE = new ReasonPhraseImpl("Range Not Satisfiable");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase REQUEST_HEADER_FIELDS_TOO_LARGE = new ReasonPhraseImpl("Request Header Fields Too Large");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase REQUEST_TIMEOUT = new ReasonPhraseImpl("Request Timeout");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase RESET_CONTENT = new ReasonPhraseImpl("Reset Content");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase SEE_OTHER = new ReasonPhraseImpl("See Other");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase SERVICE_UNAVAILABLE = new ReasonPhraseImpl("Service Unavailable");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase SWITCH_PROTOCOLS = new ReasonPhraseImpl("Switching Protocols");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase SWITCH_PROXY = new ReasonPhraseImpl("Switch Proxy");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase TEMPORARY_REDIRECT = new ReasonPhraseImpl("Temporary Redirect");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase TOO_EARLY = new ReasonPhraseImpl("Too Early");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase TOO_MANY_REQUESTS = new ReasonPhraseImpl("Too Many Requests");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase UNAUTHORIZED = new ReasonPhraseImpl("Unauthorized");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase UNAVAILABLE_FOR_LEGAL_REASONS = new ReasonPhraseImpl("Unavailable For Legal Reasons");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase UNPROCESSABLE_ENTITY = new ReasonPhraseImpl("Unprocessable Entity");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase UNSUPPORTED_MEDIA_TYPE = new ReasonPhraseImpl("Unsupported Media Type");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase UPGRADE_REQUIRED = new ReasonPhraseImpl("Upgrade Required");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase URI_TOO_LONG = new ReasonPhraseImpl("URI Too Long");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase USE_PROXY = new ReasonPhraseImpl("Use Proxy");
	/**
	 ...
	 * @since 0.0.1 ~2021.03.23
	 */
	ReasonPhrase VARIANT_ALSO_NEGOTIATES = new ReasonPhraseImpl("Variant Also Negotiates");
