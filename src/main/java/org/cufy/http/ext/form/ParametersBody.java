...
import org.cufy.http.impl.QueryImpl;
...
public class ParametersBody implements Body {
	...
	public ParametersBody(@NotNull Body body) {
		...
		this.values = QueryImpl.query(body.toString());
	}
	...
	public ParametersBody(@NotNull Map<@Nullable String, @Nullable String> map) {
		...
		this.values = QueryImpl.query(map);
	}
	...
	public ParametersBody(@NotNull @Pattern(UriRegExp.QUERY) String source) {
		...
		this.values = QueryImpl.query(source);
	}
	...
	public ParametersBody(@NotNull Query values) {
		...
		this.values = QueryImpl.query(values);
	}
	...
	public InputStream openInputStream() {
		return new ReaderInputStream(
				new StringReader(this.values.toString()),
	...
	@Contract(value = "->new", pure = true)
	public Query values() {
		return new RawQuery(this.values);
	}
}
